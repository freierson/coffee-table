...
/*A: Kenya
B: Brazil, Costa Rica, El Salvador, Ethiopia
C: Ethiopia and Sumatra
D: Colombia*/
...
reactable(
  ...
  columns = list(
    ...
    most_often = colDef(
      name = "Best describes <i class='fa-regular fa-circle-question' data-tippy-content='The coffee people were usually describing when this note was used. Multiple coffees are listed when the difference between them is not statistically significant.'></i>", format = colFormat(digits = 2),
      width = 130,
      cell = most_often,
      html = TRUE
    ),
    bitterness = colDef(
      name = "Bitterness <i class='fa-regular fa-circle-question' data-tippy-content='Positive (negative) numbers indicate people used this note to describe a coffee they found bitter (not bitter).'></i>",
      style = \(x) list(fontWeight = 600),
      cell = up_down_arrow,
      html = TRUE
    ),
    acidity = colDef(
      name = "Acidity <i class='fa-regular fa-circle-question' data-tippy-content='Positive (negative) numbers indicate people used this note to describe a coffee they found acidic (not acidic).'></i>",
      style = \(x) list(fontWeight = 600),
      cell = up_down_arrow,
      html = TRUE
    ),
    mentioned_with = colDef(name = "Complimentary note <i class='fa-regular fa-circle-question' data-tippy-content='This note often appears with the flavour note in the first column.'></i>", width = 150, html = TRUE),
    sentiment = colDef(
      name = "Sentiment <i class='fa-regular fa-circle-question' data-tippy-content='Positive (negative) numbers indicate people used this note to describe a coffee they liked (disliked).'></i>",
