    ...
    cell = JS("
      function(cellInfo, tableState) {
        ...
        return cellInfo.value.split(',').map(x => {
          return `${cellInfo.id == 'd_prop' ? '&#x1F1E8;&#x1F1F4' : '&#x1F1F0;&#x1F1EA'} <img src='https://www.svgrepo.com/show/493660/coffee-bean-filled-roast-brew.svg' class='bean-often ${x}_prop' alt = 'coffe bean'/>`
        }).join()
      }
    "), html = TRUE),
    bitterness = colDef(
